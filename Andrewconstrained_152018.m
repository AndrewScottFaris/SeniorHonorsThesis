...
a = 0.31; %weight on traded consumption in the CES aggregator
b = 0.8; %weight on importable consumption in the CES aggregator
...
yXendowmentconstant = 0.8; 
thet = 0.2; %importable good endowment as a fraction of exportable endowment, i.e. 0.5 means we produce 1 unit of ex and 0.5 units of imp
...
dupper = 0.8*(1+rstar); %upper bound of debt grid
end

if nargin<5|isempty(xiMX)
xiMX = 0.5; %elasticity of subsitution between importable and exportables
end
